...
//	userFavorInfo, err := GetFavorVideoInfoListByUserId(2)
//	if err != nil {
//		log.Println(err)
//	}
...
func TestGetFavorListByUserId(t *testing.T) {
	listByUserId, err := GetFavorListByUserId(1)
	if err != nil {
		log.Println(err)
	}
	log.Println(jsonUtils.MapToJson(listByUserId))
}
